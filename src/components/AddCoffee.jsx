...
const AddCoffee = () => {
  ...
  const handleAddCoffee = (event) => {
    ...
    return (
        <div>
            <form onSubmit={handleAddCoffee} className="p-24 bg-blue-200">
                <div >
                    <h1 className="text-3xl font-bold mb-5">Add New Coffee</h1>
                    ...
                    <div className='md:flex '>
                      ...
                      <label className="label">
                       <span className="label-text text-2xl text-orange-700 font-bold"> Coffee Name</span>
                        ...
                        <input type="text" name="name" className="input input-bordered w-full gap-7 " placeholder='Coffee Name' />
                        </label>
                      ...
                      <label className="label">
                       <span className="label-text text-2xl font-bold text-orange-700"> Coffee Quantity</span>
                        ...
                        <label className='input-group'>
                        <input type="text" name="quantity" className="input input-bordered w-full" placeholder='Coffee Quantity' />
                        </label>
                      ...
                      <label className="label">
                       <span className="label-text text-2xl text-orange-700 font-bold"> Supplier</span>
                        ...
                        <label className='input-group'>
                        <input type="text" name="supplier" className="input input-bordered w-full  " placeholder='Supplier' />
                        </label>
                      ...
                      <label className="label">
                       <span className="label-text text-2xl text-orange-700 font-bold"> Photo</span>
                        ...
                        <label className='input-group'>
                        <input type="text" name="photo" className="input input-bordered w-full gap-7 " placeholder='Photo' />
                        </label>
                    ...
                    <input type="submit" className="bg-orange-500 w-full" value="Add Coffee" />
                    </div>
                </div>
            </form>
